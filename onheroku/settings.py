"""
Django settings for onheroku project.
...
SECRET_KEY = '*8oo9y%20ob=)r&&aw$wti5$@=--c(v$a0ww#=tpu8hf2bj&d4'
...
WSGI_APPLICATION = 'onheroku.wsgi.application'
